...
try:
    ...
    print(f"RAG Error: {e}. Instalando sentence_transformers, numpy, faiss-cpu en requirements.txt.")
...
async def premium_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    args = context.args
    if user_id != OWNER_ID:
        await update.message.reply_text("Solo el admin puede dar premium. "
